...
class HomeController extends Controller
{
    ...
    protected function buildOtdp($location, string $type)
    {
        ...
        /**
         * ✅ ACTUAL - Semua ambil dari inventory_items untuk consistency
         */
                ...
                DB::raw("
                    COALESCE(
                        CASE
                            ...
                            ELSE NULL
                        END,
                        (SELECT JSON_UNQUOTE(JSON_EXTRACT(ii.custom_field, '$.cutting_center'))
                         FROM inventory_items ii
                         WHERE ii.code = od.code
                         AND ii.location_code = '{$locationCode}'
                         LIMIT 1),
                        'UNKNOWN'
                    ) as cutting_center
                "),
